# Healthcare Context Graph Application
...
start:
	@echo "Starting Healthcare Context Graph..."
	@trap 'kill 0' EXIT; \
		$(MAKE) dev-backend & \
		$(MAKE) dev-frontend & \
		wait
